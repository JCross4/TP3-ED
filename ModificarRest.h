...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label4->Text = L"Introduzca el código del restaurante:";
			// 
			// button1
			// 
	...
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		if (strCod != "" && strNombre != "") {
			...
			if (ARest->validarRestaurante(ARest->getRaiz(), intCod)) {
				...
				MessageBox::Show("Se modificó correctamente", "Restaurante", MessageBoxButtons::OK, MessageBoxIcon::Asterisk);
			}
			else {
