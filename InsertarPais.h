...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Text = L"Insertar País";
			...
			this->label3->Text = L"Introduzca el nombre del país:";
			// 
			// tbCod
			// 
...
private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	if (strCod != "" && strNombre != "") {
		...
		if (!APaises->ValidarPais(APaises->raiz, intCod)) {
			...
			MessageBox::Show("Se insertó correctamente", "País", MessageBoxButtons::OK, MessageBoxIcon::Asterisk);
		}
		else {
			MessageBox::Show("Ya existe un país con ese código", "País", MessageBoxButtons::OK, MessageBoxIcon::Error);
			tbCod->Clear();
		}
