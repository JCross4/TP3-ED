...
namespace InterfazTP3 {
	...
	/// <summary>
	/// Resumen de ConsultaCliente
	/// </summary>
	public ref class ConsultaCliente : public System::Windows::Forms::Form
	{
	...
	public:
		...
		ConsultaCliente(ArbolB* ptrClientes)
		{
			InitializeComponent();
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(111, 124);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(75, 23);
			this->button1->TabIndex = 25;
			this->button1->Text = L"Consultar";
			this->button1->UseVisualStyleBackColor = true;
			this->button1->Click += gcnew System::EventHandler(this, &ConsultaCliente::button1_Click);
			// 
			// tbCod
			// 
			this->tbCod->Location = System::Drawing::Point(79, 85);
			...
			this->label1->Text = L"Consulta Cliente";
			// 
			// ConsultaCliente
			// 
			this->AutoScaleDimensions = System::Drawing::SizeF(6, 13);
			this->AutoScaleMode = System::Windows::Forms::AutoScaleMode::Font;
			this->ClientSize = System::Drawing::Size(299, 169);
			this->Controls->Add(this->button1);
			this->Controls->Add(this->tbCod);
			this->Controls->Add(this->label2);
			this->Controls->Add(this->label1);
			this->Name = L"ConsultaCliente";
			this->Text = L"ConsultaCliente";
	...
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		if (strCod != "") {
			...
			if (AClientes->validarCedula(intCod)) {
				NodoB* cliente = AClientes->busqueda(intCod);
				...
				MessageBox::Show("Cédula: " + codStr + " Nombre: " + nombreStr, "Cliente", MessageBoxButtons::OK, MessageBoxIcon::Asterisk);
			}
			else {
				MessageBox::Show("No existe un cliente con esa cédula", "Clientes", MessageBoxButtons::OK, MessageBoxIcon::Error);
				tbCod->Clear();
			}
