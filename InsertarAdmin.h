...
namespace InterfazTP3 {
	...
	/// <summary>
	/// Resumen de InsertarAdmin
	/// </summary>
	public ref class InsertarAdmin : public System::Windows::Forms::Form
	{
	...
	public:
		...
		InsertarAdmin(ArbolB* ptrAdmins)
		{
			InitializeComponent();
			AAdmins = ptrAdmins;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(144, 224);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(75, 23);
			this->button1->TabIndex = 17;
			this->button1->Text = L"Insertar";
			this->button1->UseVisualStyleBackColor = true;
			this->button1->Click += gcnew System::EventHandler(this, &InsertarAdmin::button1_Click);
			// 
			// tbNombre
			// 
			this->tbNombre->Location = System::Drawing::Point(114, 159);
			...
			// tbCod
			// 
			this->tbCod->Location = System::Drawing::Point(114, 91);
			...
			this->label3->Location = System::Drawing::Point(8, 132);
			this->label3->Name = L"label3";
			this->label3->Size = System::Drawing::Size(342, 24);
			this->label3->TabIndex = 14;
			this->label3->Text = L"Introduzca el nombre del administrador:";
			// 
			// label2
			// 
			...
			this->label1->Text = L"Insertar Administrador";
			// 
			// InsertarAdmin
			// 
			this->AutoScaleDimensions = System::Drawing::SizeF(6, 13);
			this->AutoScaleMode = System::Windows::Forms::AutoScaleMode::Font;
			this->ClientSize = System::Drawing::Size(351, 259);
			...
			this->Name = L"InsertarAdmin";
			this->Text = L"InsertarAdmin";
	...
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		if (strCedula != "" && strNombre != "") {
			...
			if (!AAdmins->validarCedula(intCedula)) {
				AAdmins->insertarNuevoCliente(intCedula, strNombre);
				MessageBox::Show("Se insertó correctamente", "Administrador", MessageBoxButtons::OK, MessageBoxIcon::Asterisk);
			}
			else {
				MessageBox::Show("Ya existe un administrador con esa cedula", "Administrador", MessageBoxButtons::OK, MessageBoxIcon::Error);
				tbCod->Clear();
			}
