...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label3->Text = L"Introduzca el nuevo nombre del país:";
			// 
			// label2
			// 
			...
			this->label1->Text = L"Modificar País";
			// 
			// ModificarPais
			// 
	...
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		if (strCod != "" && strNombre != "") {
			...
			if (APaises->ValidarPais(APaises->raiz, intCod)) {
				...
				MessageBox::Show("Se modificó correctamente", "País", MessageBoxButtons::OK, MessageBoxIcon::Asterisk);
			}
			else {
