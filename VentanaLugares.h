...
#include <iostream>
#include "TP3.h"
#include "OpcionesPaises.h"
#include "OpcionesCiudad.h"
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(VentanaLugares::typeid));
			...
			this->button1->Location = System::Drawing::Point(62, 40);
			...
			this->button1->Click += gcnew System::EventHandler(this, &VentanaLugares::button1_Click);
			// 
			// button2
			// 
			...
			this->button2->Location = System::Drawing::Point(62, 184);
			...
			this->button2->Click += gcnew System::EventHandler(this, &VentanaLugares::button2_Click);
			// 
			// VentanaLugares
			// 
			this->AutoScaleDimensions = System::Drawing::SizeF(6, 13);
			this->AutoScaleMode = System::Windows::Forms::AutoScaleMode::Font;
			this->ClientSize = System::Drawing::Size(271, 315);
			this->Controls->Add(this->button2);
			this->Controls->Add(this->button1);
			this->Name = L"VentanaLugares";
			this->Text = L"VentanaLugares";
