	...
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		if (strCod != "") {
			...
			if (AAdmins->validarCedula(intCod)) {
				...
				MessageBox::Show("Cédula: " + codStr + " Nombre: " + nombreStr, "Administradores", MessageBoxButtons::OK, MessageBoxIcon::Asterisk);
			}
			else {
				MessageBox::Show("No existe un administrador con esa cédula", "Administradores", MessageBoxButtons::OK, MessageBoxIcon::Error);
				tbCod->Clear();
			}

		}
		else {
			MessageBox::Show("Debe introducir la información", "Administradores", MessageBoxButtons::OK, MessageBoxIcon::Error);
		}
	}
};
}
